...
public class RegistrationFirestoreFragment extends Fragment {
    ...
    public RegistrationFirestoreFragment() {
    }
        ...
        fAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    DocumentReference documentReference = db.collection("Firestore__Db_Users").document(UserID);
